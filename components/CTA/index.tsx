          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                ¡Únete Hoy y Comienza tu Aventura Épica!
              </h2>
              <p>
                Crea tu cuenta y forma parte de una comunidad activa de
                aventureros. Explora, combate y progresa en un mundo lleno de
                desafíos. ¡Tu historia en Azeroth comienza ahora!
              </p>
            </motion.div>
            <motion.div
              variants={{
